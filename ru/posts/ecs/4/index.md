...
1. **N**: Общее число сущностей - пусть будет 100.000.
...
При линейной итерации максимизируется утилизация prefetcher'а (почитать об этом можно вот [тут](Cache_prefetching)).
