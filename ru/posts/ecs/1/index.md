...
В самом тупом варианте данные можно представить как двухмерный массив или таблицу, где каждая строка - это тип компонента, а каждый столбец - индекс нашей сущности, примерно вот так:
